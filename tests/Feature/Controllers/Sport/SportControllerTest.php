...
it('renders sports index page', function (): void {
    ...
    $user->givePermissionTo(Permission::LIST_SPORTS->value);
...
it('denies access to sports index without permission', function (): void {
    $user = User::factory()->create();
...
it('renders sport create page', function (): void {
    $user = User::factory()->create();
    $user->givePermissionTo(Permission::CREATE_SPORT->value);
...
it('denies access to sport create without permission', function (): void {
    $user = User::factory()->create();
...
it('requires name when creating sport', function (): void {
    $user = User::factory()->create();
    $user->givePermissionTo(Permission::CREATE_SPORT->value);
...
it('enforces max length for name when creating sport', function (): void {
    $user = User::factory()->create();
    $user->givePermissionTo(Permission::CREATE_SPORT->value);
...
it('enforces unique name when creating sport', function (): void {
    $user = User::factory()->create();
    $user->givePermissionTo(Permission::CREATE_SPORT->value);
...
it('renders sport edit page', function (): void {
    $user = User::factory()->create();
    $user->givePermissionTo(Permission::UPDATE_SPORT->value);
...
it('denies access to sport edit without permission', function (): void {
    $user = User::factory()->create();
    $sport = Sport::factory()->create();
...
it('requires name when updating sport', function (): void {
    $user = User::factory()->create();
    $user->givePermissionTo(Permission::UPDATE_SPORT->value);
...
it('enforces max length for name when updating sport', function (): void {
    $user = User::factory()->create();
    $user->givePermissionTo(Permission::UPDATE_SPORT->value);
...
it('enforces unique name when updating sport', function (): void {
    $user = User::factory()->create();
    $user->givePermissionTo(Permission::UPDATE_SPORT->value);
